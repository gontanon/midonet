...
object MidonetMediaTypes {
    ...
    final val NEUTRON_IPSEC_SITE_CONNS_JSON_V1 = "application/vnd.org.midonet.neutron.IpsecSiteConns-v1+json"
    ...
    final val APPLICATION_MAC_IP_COLLECTION_JSON = "application/vnd.org.midonet.MacIp-v1+json"
    ...
    final val APPLICATION_SERVICE_CONTAINER_JSON = "application/vnd.org.midonet.ServiceContainer-v1+json"
